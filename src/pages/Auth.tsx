      ...
      <div className="w-full max-w-md aria-panel rounded-3xl p-8">
        ...
        {googleOAuthSupported ? (
          ...
          <p className="mt-5 text-[11px] text-center text-muted-foreground leading-relaxed">
            Google sign-in is only available on the Lovable-hosted domain. Use email + password here, or open the app on its <code className="px-1 py-0.5 rounded bg-muted">.lovable.app</code> URL for one-click Google login.
          </p>
        )}
      </div>
    </div>
